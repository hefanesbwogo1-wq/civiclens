...
if (!supabaseClient) {
    showError("CivicLens configuration is unavailable.");
    return;
}
...
```
    ...
    for (const leader of leaders) {
        /*
         * Backend returns leader objects:
         * {
         *   id,
         *   full_name,
         *   public_name,
    ...
    if (
        currentValue &&
        leaderNames.includes(currentValue)
    ) {
        elements.leader.value =
            currentValue;
    }
...
```
elements.testMention.disabled = true;
...
try {
    ...
    elements.testMention.disabled = false;
}
```
...
/* =========================================================
GLOBAL CIVICLENS API
========================================================= */

window.civicLensMentions = {
loadMentions,
loadStats,
loadLeaders,
refreshMentions,
...
console.log(
"CivicLens: mentions.js file loaded."
);
